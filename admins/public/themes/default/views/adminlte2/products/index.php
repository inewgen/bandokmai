...
<div class="content-wrapper">
        ...
        <div class="row">
            <div class="col-xs-12">
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <form id="frm_products" role="form" method="post" action="<?php echo URL::to('products');?>" enctype="multipart/form-data">
    ...
    <?php endif;?>
                                    ...
                                    <?php endif;?>
                                        ...
                                        <td>
                                            <a title="Edit" href="<?php echo URL::to('products');?>/<?php echo $value['id'];?>"><span class="glyphicon glyphicon-pencil"></span></a>
                                            <a class="del_products" data="<?php echo $value['id'];?>" title="Delete" href="javascript:void(0)" onclick="del_products('<?php echo array_get($value, 'id', 0);?>', '<?php echo array_get($value, 'images.0.ids', 0);?>', '<?php echo array_get($value, 'member_id', 0);?>')">
