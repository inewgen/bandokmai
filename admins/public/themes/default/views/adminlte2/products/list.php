...
<div class="content-wrapper">
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-header">
                        ...
                        <a href="<?php echo URL::to('products/add');?>">
                            <button class="btn btn-success" id="new_products">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <form id="frm_main" role="form" method="get" action="<?php echo URL::to('products');?>" enctype="multipart/form-data">
                            
                            <div class="row">
                                <div class="col-xs-6">
                                    <div id="tb_products_length" class="dataTables_length">
                                        <label>
                                            <select id="perpage" name="perpage" size="1" aria-controls="tb_products">
    ...
    <?php foreach ($data as $key => $value): ?>
                    ...
                    <?php           else: ?>
                                        <td>
                                            <img src="<?php echo getImageLink('img', 'products', 'siamts', 'png', 200, 143, 'products.jpg');?>" width="200" height="143">
                                        </td>
                    <?php           endif;?>
                    <?php       elseif ($key2 == 'title'): ?>
                                        <td>
                                            <a title="Edit" href="<?php echo URL::to('products');?>/<?php echo array_get($value, 'id', '');?>">
                                            <?php echo array_get($value ,$key2, '');?>
                                            </a>
                                        </td>
                    <?php       elseif ($key2 == 'manage'): ?>
                                        <td>
                                            <a title="Edit" href="<?php echo URL::to('products');?>/<?php echo array_get($value, 'id', '');?>"><span class="glyphicon glyphicon-pencil"></span></a>
    ...
    <?php endif;?>
                            ...
                            <div class="row">
                                <div class="col-xs-6">
                                    <div class="dataTables_info" id="tb_products_info">Showing <?php echo $pagination->getFrom();?>
                        ...
                        <form id="frm_main2" role="form" method="post" action="<?php echo URL::to('products');?>" enctype="multipart/form-data">
