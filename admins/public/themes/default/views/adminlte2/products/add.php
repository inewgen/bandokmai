        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form id="frm_main" role="form" method="post" action="<?php echo URL::to('products/add');?>" enctype="multipart/form-data">
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" placeholder="" name="price" class="form-control" maxlength="250">
                            </div>
                            <div class="form-group">
                                <label for="">Normal Price</label>
                                <input type="text" placeholder="" name="price_normal" class="form-control" maxlength="250">
                            </div>
                            <div class="form-group">
                                <label for="">Stock <font color="red">*</font></label>
                                <input type="text" placeholder="" name="stock" class="form-control" maxlength="250">
                            </div>
                            <div class="form-group">
