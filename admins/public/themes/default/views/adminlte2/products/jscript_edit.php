...
<script type="text/javascript">
    ...
    $(function () {
        ...
        var url_to_autocomplete_api = '<?php echo URL::to("products/tags");?>';
        ...
        $("#frm_main").validate({
            ...
            messages: {
                ...
                // price_normal: "This field is required",
        ...
        $('#file_upload').uploadify({
            'formData'     : {
                ...
                'token':     '<?php echo md5(Config::get("web.ranbandokmaisod-keys") . $timestamp);?>'
            },
