...
<div class="content-wrapper">
                ...
                <div class="box">
                    <div class="box-header">
                        ...
                        <a href="<?php echo URL::to('navigations/add');?>">
                            <button class="btn btn-success" id="new_navigations">
                    ...
                    <!-- /.box-header -->
                    <div class="box-body">
                        <form id="frm_main" role="form" method="get" action="<?php echo URL::to('navigations');?>" enctype="multipart/form-data">
                            
                            <div class="row">
                                <div class="col-xs-6">
                                    <div id="tb_navigations_length" class="dataTables_length">
                                        <label>
                                            <select id="perpage" name="perpage" size="1" aria-controls="tb_navigations">
    ...
    <?php foreach ($data as $key => $value): ?>
                    ...
                    <?php           if(array_get($value, 'images.0.url', false)): ?>
                                        <td>
                                            <img src="<?php echo getImageLink('images', array_get($value, 'images.0.user_id', ''), array_get($value, 'images.0.code', ''), array_get($value, 'images.0.extension', ''), 200, 70, array_get($value, 'images.0.name', ''));?>" width="200px">
                                        </td>
                    <?php           else: ?>
                                        <td>
                                            <img src="<?php echo getImageLink('img', 'navigations', 'siamts', 'png', 200, 70, 'banner.jpg');?>" width="200px">
                                        </td>
                    <?php           endif;?>
                    <?php       elseif ($key2 == 'manage'): ?>
                                        <td>
                                            <a title="Edit" href="<?php echo URL::to('navigations');?>/<?php echo array_get($value, 'id', '');?>"><span class="glyphicon glyphicon-pencil"></span></a>
    ...
    <?php endif;?>
                            ...
                            <div class="row">
                                <div class="col-xs-6">
                                    <div class="dataTables_info" id="tb_navigations_info">Showing <?php echo $pagination->getFrom();?>
                        ...
                        <form id="frm_main2" role="form" method="post" action="<?php echo URL::to('navigations');?>" enctype="multipart/form-data">
