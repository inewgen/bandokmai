...
<script type="text/javascript">
  $(function () {
    ...
    $("#tb_navigations_filter input").keyup(function(e) {
        var search = $(this).val();
        if(search != ''){
            $("#tb_navigations tbody").sortable('disable');
        }else{
            $("#tb_navigations tbody").sortable('enable');
        }
    });

    $("#tb_navigations tbody").sortable({
    ...
    $( "#tb_navigations tbody" ).disableSelection();
