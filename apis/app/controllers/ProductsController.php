...
class ProductsController extends ApiController
{
    ...
    public function index()
    {
        ...
        $query = Products::filters($filters)
                ->with('images')
                ->with('categories')
                ->with('tags')
                ->orderBy($order, $sort);
    ...
    public function store()
    {
        ...
        $parameters = array(
            ...
            'price_normal'     => (isset($data['price_normal'])?$data['price_normal']:''),
